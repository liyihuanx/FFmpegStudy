    ...
    static void AllocNativeImage(NativeImage *pImage) {
        ...
        switch (pImage->format) {
            ...
            case IMAGE_FORMAT_I420: {
                ...
                break;
            default:
                LOGD("NativeImageUtil::AllocNativeImage do not support the format. Format = %d",
                     pImage->format);
                break;
        }
    }
...
//	    LOGD("NativeImageUtil::CopyNativeImage src[w,h,format]=[%d, %d, %d], dst[w,h,format]=[%d, %d, %d]", pSrcImg->width, pSrcImg->height, pSrcImg->format, pDstImg->width, pDstImg->height, pDstImg->format);
//        LOGD("NativeImageUtil::CopyNativeImage src[line0,line1,line2]=[%d, %d, %d], dst[line0,line1,line2]=[%d, %d, %d]", pSrcImg->pLineSize[0], pSrcImg->pLineSize[1], pSrcImg->pLineSize[2], pDstImg->pLineSize[0], pDstImg->pLineSize[1], pDstImg->pLineSize[2]);
        ...
        if (pSrcImg->format != pDstImg->format || pSrcImg->width != pDstImg->width ||
            ...
            LOGD("NativeImageUtil::CopyNativeImage invalid params.");
            return;
        }
        ...
        switch (pSrcImg->format) {
            ...
            case IMAGE_FORMAT_RGBA: {
                ...
                break;
            default: {
                LOGD("NativeImageUtil::CopyNativeImage do not support the format. Format = %d",
                     pSrcImg->format);
            }
                break;
        }
